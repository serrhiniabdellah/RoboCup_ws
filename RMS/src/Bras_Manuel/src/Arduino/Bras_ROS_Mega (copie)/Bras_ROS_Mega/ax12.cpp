...
void AX12::clearOverloadError() {
    // Ecrire 0 dans le registre des erreurs pour effacer l'erreur de surcharge
    writeData(0x70, 1, 0); // Registre 0x70 est le registre des erreurs
}
