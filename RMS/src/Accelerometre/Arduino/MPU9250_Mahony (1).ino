...
// mag offsets and correction matrix
  float M_B[3]
  {50.817566, 27.160426, -5.301095};// Valeurs faite par calib a Mantes le 06mai

 //{   18.15,   28.05,  -36.09};ligne d'origine

 //{54.328697, 27.001413, -3.759477};// Valeurs faite par calib a st germain le 05mai
...
ros::Publisher chatter("chatter", &vect);
...
void loop()
{
  ...
  yaw = -yaw + 14.5; //Ligne originale
  //yaw = -yaw + 1.74;//St germain
