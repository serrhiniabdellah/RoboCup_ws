...
void JointState( const std_msgs::Int16MultiArray joint_states){ 
    ...
    SimplePos(servoID_0, retour_angle.data[0], 30);//Axe1
    DoublePose(servoID_1,servoID_2, retour_angle.data[1], retour_angle.data[1],30);//Axe2
    //DoublePose(servoID_3,servoID_4, retour_angle.data[2], retour_angle.data[2],100); Je revup bien la valeur mais je touche psa -> il reste bloque le con
    SimplePos(servoID_5, retour_angle.data[3], 30);
    SimplePos(servoID_6, retour_angle.data[4], 30);
...
void Script_Bidon()
{
 ...
 //DoublePose(servoID_1,servoID_2,2048,2048,-30);// 100 4000 pour couple 3_4 droit par rapport a la pos repos Lmax 4095 0 pos repos  sens de rotation, +-
      delay(1000);
 //DoublePose(servoID_3,servoID_4,4095,0,50);//-
   //   delay(4000);
//SimplePos(servoID_4,2048,30);
  //    delay(4000);
//SimplePos(servoID_5,2048,30);


   //Serial.println(SERIAL_SERVO.read());
...
void setup() { 
  ...
  DoublePose(servoID_3,servoID_4, 2048, 2048,30);
  SimplePos(servoID_5, 2048, 30);
  SimplePos(servoID_6, 2048, 30);
*/
  //Script_Bidon();
